...
<li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <div id="collapsePatient" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <!--<h6 class="collapse-header">Custom Components:</h6>-->
        <a class="collapse-item" href="dashboard/patient-contact">Patient Feedback</a>
        <a class="collapse-item" href="dashboard/register">Appointments</a>
...
<!--<div id="content-wrapper" class="d-flex flex-column">-->
  ...
  <!--<div id="content">-->
    ...
    <div class="container-fluid ">
      ...
      <h4 class="card-title">Appointments of Patients</h4>
      @if (session('status'))
      ...
      <th class="table-primary">Phone Num:</th>
      <th class="table-primary">Doctor Name</th>
      
      <th class="table-primary">Message</th>
      <th class="table-primary">File</th>
      <th class="table-primary">Created_at</th>
