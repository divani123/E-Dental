...
<li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <div id="collapsePatient" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <!--<h6 class="collapse-header">Custom Components:</h6>-->
        <a class="collapse-item" href="dashboard/patient-contact">Patient Management</a>
...
<!--<div id="content-wrapper" class="d-flex flex-column">-->
  ...
  <!--<div id="content">-->
    ...
    <div class="container-fluid">
      ...
      <h4 class="card-title">FeedBacks of Patients</h4>
      @if (session('status'))
      ...
      <th class="table-primary">Subject</th>
      ...
      <td>{{$row->message}}</td>
<td>
<form action="/contact-delete/{{$row->id  }}" method="post">
{{csrf_field()}}
{{method_field('DELETE')}}
